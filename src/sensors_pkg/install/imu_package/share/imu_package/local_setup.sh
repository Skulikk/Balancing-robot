...
: ${AMENT_CURRENT_PREFIX:="/home/skulikk/robot/src/imu_package/install/imu_package"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/imu_package/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/imu_package/environment/path.sh"
