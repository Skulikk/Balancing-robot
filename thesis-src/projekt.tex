...
\projectinfo{
  ...
  title.cs={Balancující dvoukolový robot},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  title.en={Balancing two-wheeled robot}, % název práce v angličtině / thesis title in english
  ...
  author.surname={Skolek},   % příjmení autora / author surname 
...
% I have listed all the literary sources, publications and other sources, which were used during the preparation of this thesis.},
  ...
  acknowledgment={Rád bych poděkoval vedoucímu práce, panu docentu Vladimíru Janouškovi za vedení práce a konzultace. Chci poděkovat také rodičům, za podporu a poskytnutí zdrojů k této práci.},
...
%(external submitter, consultant, etc.).},
  ...
  department.en={Department of Intelligent Systemss} % Ústav v angličtině - pro využití této položky výše zvolte ústav DEF nebo jej zakomentujte / Department in English - for use of this entry select DEF above or comment it out
}
