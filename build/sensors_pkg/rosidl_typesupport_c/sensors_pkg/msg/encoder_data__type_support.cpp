...
static const _EncoderData_type_support_symbol_names_t _EncoderData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sensors_pkg, msg, EncoderData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sensors_pkg, msg, EncoderData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sensors_pkg, msg, EncoderData)() {
  return &::sensors_pkg::msg::rosidl_typesupport_c::EncoderData_message_type_support_handle;
}
