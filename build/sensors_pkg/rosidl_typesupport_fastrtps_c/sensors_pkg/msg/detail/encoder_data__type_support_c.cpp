...
#include "sensors_pkg/msg/detail/encoder_data__rosidl_typesupport_fastrtps_c.h"
...
#include "sensors_pkg/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _EncoderData__ros_msg_type = sensors_pkg__msg__EncoderData;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sensors_pkg
size_t get_serialized_size_sensors_pkg__msg__EncoderData(
  const void * untyped_ros_message,
...
static uint32_t _EncoderData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sensors_pkg__msg__EncoderData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sensors_pkg
size_t max_serialized_size_sensors_pkg__msg__EncoderData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sensors_pkg__msg__EncoderData;
    is_plain =
      (
...
static size_t _EncoderData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sensors_pkg__msg__EncoderData(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sensors_pkg, msg, EncoderData)() {
